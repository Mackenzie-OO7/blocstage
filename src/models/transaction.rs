...
impl Transaction {
    ...
    //     status: &str,
    // ) -> Result<Self> {
    //     if ticket_amount.is_negative() || sponsorship_fee.is_negative() {
    //         anyhow::bail!("Transaction amounts cannot be negative");
    //     }

    //     let id = Uuid::new_v4();
    //     let now = Utc::now();
    //     let total_amount = &ticket_amount + &sponsorship_fee;
